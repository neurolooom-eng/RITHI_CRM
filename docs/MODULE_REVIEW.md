...
**Batch 3 (2026-09-25, v0.9.375):** 5, 18 and 22 are fixed, and so are the
rest of 21 and 45; 15 is fixed in part. Batch 2 is merged (#422).
...
| 5 | Product & Party Search | A machine search stops at 200 rows and says nothing — **FIXED in batch 3 (v0.9.375)** | Medium |
...
| 15 | *cross-cutting* | Nine paged reads order by a column that is not unique — rows doubled and dropped (**measured in Postgres**) — **PART-FIXED in batch 3: five of the nine reads now have a unique tiebreaker** | High |
