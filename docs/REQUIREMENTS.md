...
**71** user requirements · **83** system requirements · **30** call-request · **44** servicing · **79** tests · **4** recorded as non-auditable · **117** of 71 user requirements tied to a module.
---
...
**102** links · **71** user requirements · **83** system requirements · **74** tests · **71** requirements traced end to end, **0** in part, **0** not yet.
