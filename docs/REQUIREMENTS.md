...
**76** user requirements · **89** system requirements · **30** call-request · **44** servicing · **84** tests · **5** recorded as non-auditable · **126** of 76 user requirements tied to a module.
---
...
**108** links · **76** user requirements · **89** system requirements · **79** tests · **76** requirements traced end to end, **0** in part, **0** not yet.
