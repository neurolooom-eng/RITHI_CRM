...
**2 of 60.** Each is written down with its reason in
...
**70** user requirements · **82** system requirements · **30** call-request · **44** servicing · **78** tests · **4** recorded as non-auditable · **114** of 70 user requirements tied to a module.
---
