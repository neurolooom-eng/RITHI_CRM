...
- **Run at** 2026-09-20T22:43:08.238Z
- **Took** 72s
- **Commit** `271339e` on `claude/tender-rubin-8ian45`
- **Version** 0.9.323
...
| | Result | |
| --- | --- | --- |
| `247 migrations applied to a fresh database` | ✅ pass |  |
...
| `check:generated` | ✅ pass | every generated bundle matches its migrations (58 checked) |
