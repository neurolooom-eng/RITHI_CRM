...
- **Run at** 2026-09-26T09:58:55.972Z
- **Took** 87s
- **Commit** `898f4ef` on `claude/tender-rubin-8ian45`
- **Version** 0.9.376
...
| | Passed | Total |
| --- | --- | --- |
| Database suites | 102 | 102 |
| Automated checks | 22 | 22 |
| Labelled `expect ERROR` outcomes matched | 180 | 180 |
...
| | Result | |
| --- | --- | --- |
| `265 migrations applied to a fresh database` | ✅ pass |  |
...
| `check:status` | ✅ pass | every one of the 195 _status.sql rows reads yes on a fully-applied database (1 skipped) |
