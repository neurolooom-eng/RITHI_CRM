...
- **Run at** 2026-09-24T14:00:40.666Z
- **Took** 78s
- **Commit** `ec74d9c` on `claude/field-service-module-poc-hslouq`
- **Version** 0.9.366
...
| `check:status` | ✅ pass | every one of the 193 _status.sql rows reads yes on a fully-applied database (1 skipped) |
