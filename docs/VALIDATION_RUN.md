...
- **Run at** 2026-09-18T09:33:39.513Z
- **Took** 67s
- **Commit** `c1a6538` on `claude/tender-rubin-8ian45`
- **Version** 0.9.297
...
| | Result | |
| --- | --- | --- |
| `235 migrations applied to a fresh database` | ✅ pass |  |
...
| `check:generated` | ✅ pass | every generated bundle matches its migrations (51 checked) |
...
| `check:status` | ✅ pass | every one of the 173 _status.sql rows reads yes on a fully-applied database (1 skipped) |
