...
- **Run at** 2026-09-15T18:57:23.218Z
- **Took** 57s
- **Commit** `1e6276a` on `claude/tender-rubin-8ian45`
- **Version** 0.9.283
...
| | Passed | Total |
| --- | --- | --- |
| Database suites | 82 | 83 |
| Automated checks | 12 | 13 |
...
| | Result | |
| --- | --- | --- |
| `229 migrations applied to a fresh database` | ✅ pass |  |

## Automated checks

| | Result | |
| --- | --- | --- |
| `check:bundles` | ✅ pass | no NEW object is split across modules (347 checked, 37 known and listed) |
...
| `check:safe-updates` | ✅ pass | no WHERE-less update or delete in any of the 190 functions |
| `check:status` | ✅ pass | every one of the 167 _status.sql rows reads yes on a fully-applied database (1 skipped) |
