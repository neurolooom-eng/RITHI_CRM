...
- **Run at** 2026-09-15T05:56:00.889Z
- **Took** 59s
- **Commit** `b2ff3c5` on `claude/field-service-module-poc-hslouq`
- **Version** 0.9.265
...
| | Result | |
| --- | --- | --- |
| `221 migrations applied to a fresh database` | ✅ pass |  |
...
| `check:status` | ✅ pass | every one of the 161 _status.sql rows reads yes on a fully-applied database (1 skipped) |
