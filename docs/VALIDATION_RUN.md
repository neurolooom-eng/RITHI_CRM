...
- **Run at** 2026-09-26T17:02:05.672Z
- **Took** 93s
- **Commit** `f43f9a6` on `claude/usage-k7slq0`
- **Version** 0.9.378
...
| | Passed | Total |
| --- | --- | --- |
| Database suites | 104 | 104 |
| Automated checks | 22 | 22 |
| Labelled `expect ERROR` outcomes matched | 187 | 187 |
...
| | Result | |
| --- | --- | --- |
| `268 migrations applied to a fresh database` | ✅ pass |  |
...
| `check:generated` | ✅ pass | every generated bundle matches its migrations (94 checked) |
...
| `check:replay` | ✅ pass | every bundle (26) replays with no change to the schema |
...
| `check:status` | ✅ pass | every one of the 197 _status.sql rows reads yes on a fully-applied database (1 skipped) |
