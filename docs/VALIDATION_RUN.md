...
- **Run at** 2026-09-15T03:52:38.779Z
- **Took** 66s
- **Commit** `67f60cf` on `claude/field-service-module-poc-hslouq`
- **Version** 0.9.262
...
| | Passed | Total |
| --- | --- | --- |
| Database suites | 77 | 77 |
| Automated checks | 13 | 13 |
| Labelled `expect ERROR` outcomes matched | 155 | 155 |
...
| `check:status` | ✅ pass | every one of the 159 _status.sql rows reads yes on a fully-applied database (1 skipped) |
