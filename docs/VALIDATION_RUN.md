...
- **Run at** 2026-09-22T18:47:46.238Z
- **Took** 80s
- **Commit** `0133cda` on `claude/field-service-module-poc-hslouq`
- **Version** 0.9.347
...
| | Result | |
| --- | --- | --- |
| `check:bundles` | ✅ pass | no NEW object is split across modules (382 checked, 37 known and listed) |
