...
- **Run at** 2026-09-15T08:56:01.817Z
- **Took** 64s
- **Commit** `cd74f76` on `claude/field-service-module-poc-hslouq`
- **Version** 0.9.268
...
| | Passed | Total |
| --- | --- | --- |
| Database suites | 81 | 81 |
| Automated checks | 13 | 13 |
| Labelled `expect ERROR` outcomes matched | 158 | 158 |
...
| | Result | |
| --- | --- | --- |
| `223 migrations applied to a fresh database` | ✅ pass |  |

## Automated checks

| | Result | |
| --- | --- | --- |
| `check:bundles` | ✅ pass | no NEW object is split across modules (340 checked, 37 known and listed) |
...
| `check:safe-updates` | ✅ pass | no WHERE-less update or delete in any of the 186 functions |
| `check:status` | ✅ pass | every one of the 163 _status.sql rows reads yes on a fully-applied database (1 skipped) |
