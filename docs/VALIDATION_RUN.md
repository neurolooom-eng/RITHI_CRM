...
| | Result | |
| --- | --- | --- |
| `273 migrations applied to a fresh database` | ✅ pass |  |
...
| `check:orders` | ✅ pass |   ✓ 133 order columns across 60 relations |
...
| `check:status` | ✅ pass | every one of the 203 _status.sql rows reads yes on a fully-applied database (1 skipped) |
