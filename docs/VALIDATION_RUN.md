...
- **Run at** 2026-09-15T04:12:14.542Z
- **Took** 73s
- **Commit** `c2596e8` on `claude/field-service-module-poc-hslouq`
- **Version** 0.9.263
...
| | Result | |
| --- | --- | --- |
| `220 migrations applied to a fresh database` | ✅ pass |  |
...
| `check:status` | ✅ pass | every one of the 160 _status.sql rows reads yes on a fully-applied database (1 skipped) |
