...
const MODULES = {
  ...
  handstock: {
    ...
    files: ['0023_handstock.sql', '0038_spare_consumption_scope.sql', '0039_material_returns.sql',
            ...
            // ...except a reconciliation, the one path built for a part fitted
            // but never reported (the user, 2026-09-26). Replaces 0214's
            // function body, so it must follow 0214 in this same module.
