...
const MODULES = {
  ...
  masters: {
    ...
    needs: ['profiles', 'rbac'],
    files: ['0021_master_lists.sql', '0066_master_values_active.sql', '0067_master_list_permissions.sql', '0076_party_key.sql'],
  },
  reports: {
    title: 'Reports',
  ...
  handstock: {
    ...
    files: ['0023_handstock.sql', '0038_spare_consumption_scope.sql', '0039_material_returns.sql',
            ...
            '0065_refurb_stock_and_part_master.sql', '0074_handstock_opening.sql', '0075_spare_history.sql', '0078_consumption_grir.sql'],
    tail: () => cookbook(),
  },
  sales_contracts: {
    ...
    needs: ['profiles', 'rbac', 'isAdmin'],
    files: ['0036_sales_contracts.sql', '0037_cover_import_speed.sql', '0072_ownership_transfer.sql', '0073_product_additional_entries.sql', '0077_upsert_targets.sql'],
  },
  stock_transfer: {
