...
const SECTIONS: Sec[] = [
  {
    id: 'request', group: 'Calls', n: '1', title: 'Request a call', who: 'Any engineer',
  ...
  {
    id: 'spare', group: 'Spares & stock', n: '5', title: 'Raise a spare request', who: 'Any engineer',
  ...
  {
    id: 'spare-engineer', n: '11', title: 'Change the engineer on a spare order', who: 'Administrators',
  ...
  {
    id: 'handstock', n: '12', title: 'Check and correct hand stock', who: 'Engineer, Spare Coordinator',
  ...
  {
    id: 'mrn', n: '13', title: 'Return spares to Stores, or move them', who: 'Engineer, Stores',
  ...
  {
    id: 'ffr', n: '16', title: 'Work a Field Failure Report', who: 'NSM, RA/QA',
  ...
  {
    id: 'feedback', n: '18', title: 'Customer feedback', who: 'Any engineer',
  ...
  {
    id: 'cover-entry', group: 'Warranty & contract', n: '19', title: 'Create a warranty sale or contract entry', who: 'Commercial',
  ...
  {
    id: 'ownership', n: '20', title: 'Move a machine to another customer', who: 'Commercial',
  ...
  {
    id: 'indoor', group: 'Workshop', n: '21', title: 'Book a unit through the workshop', who: 'Indoor engineer',
  ...
  {
    id: 'bulk', group: 'Loading data', n: '22', title: 'Load a register from a file', who: 'Admin, Coordinators',
  ...
  {
    id: 'ffr-years', n: '23', title: 'Load the old Field Failure years', who: 'Admin, RA/QA',
  ...
  {
    id: 'objective', group: 'Analysis & reports', n: '24', title: 'Re-calculate an objective and show its working', who: 'NSM, RA/QA',
  ...
  {
    id: 'exports', n: '25', title: 'Take the reports out', who: 'Managers, Coordinators',
  ...
  {
    id: 'masters', group: 'Masters & search', n: '26', title: 'Add or retire a value on a master list', who: 'Whoever maintains that list',
  ...
  {
    id: 'lookup', n: '27', title: 'Find a machine or a customer', who: 'Anyone',
  ...
  {
    id: 'password', group: 'Your account & the app', n: '28', title: 'Reset your password', who: 'Any engineer',
  ...
  {
    id: 'signature', n: '29', title: 'Save your signature', who: 'Anyone',
  ...
  {
    id: 'build', n: '30', title: 'Find the Build ID (for support)', who: 'When something looks wrong',
  ...
  {
    id: 'sync', n: '31', title: 'Refresh, Sync & Clear Cache', who: 'Keeping your data fresh',
  ...
  {
    id: 'tracker', n: '33', title: 'Use the Tracker', who: 'Anyone with access',
