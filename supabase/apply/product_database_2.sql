...
begin
  ...
  if to_regprocedure('public.party_service_engineer(text)') is null then
    missing := array_append(missing, 'party_service_engineer() — 0200_party_service_engineer.sql (apply bundle: masters)');
  end if;
